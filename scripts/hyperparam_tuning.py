...
from src.forecasting.ml_forecasting import MissingValueConfig
from src.dl.dataloaders import TimeSeriesDataModule
from src.dl.models import SingleStepRNNConfig, SingleStepRNNModel, Seq2SeqConfig, Seq2SeqModel 
...
def main():
    ...
    initial_params = ["GRU", 32, 1, True, 1e-2]
    initial_temp = 1000
    steps = 500
